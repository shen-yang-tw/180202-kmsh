...
var table = new Tabulator("#rating_table", {
  ...
  {title:"隊伍名稱", field:"name", width:100, headerFilter:"input", headerFilterPlaceholder:"隊伍名稱"},
  // {title:"作品名稱", field:"work", formatter:"link", formatterParams:{url:function(cell){return "http://" + cell.getData().url}}},
  {title:"作品名稱", field:"work", width:100, formatter:"link", formatterParams:{urlField:"work_url",}, width:120, headerFilter:"input", headerFilterPlaceholder:"作品名稱"},
  {title:"作品檔案", field:"download", width:100, formatter:"link", formatterParams:{label:"檔案下載"}, align:"center"},
  {title:"是否抄襲", field:"copy", width:100, align:"center"},
  {title:"推薦國賽", field:"recommend", width:100, align:"center"},
  {title:"教師評分", field:"rate", width:100, align:"center"},
  ...
  {title:"功能", field:"rating", formatter:"link", formatterParams:{label:"評分"}, align:"center"},
  ],
